...
void M_DrawSaveLoadBorder(int x,int y)
{
    ...
    void *left = W_CacheLumpName(DEH_String("M_LSLEFT"),PU_CACHE);
    void *cntr = W_CacheLumpName(DEH_String("M_LSCNTR"),PU_CACHE);
    void *rgt =  W_CacheLumpName(DEH_String("M_LSRGHT"),PU_CACHE);
